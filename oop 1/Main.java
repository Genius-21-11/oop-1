...
public class Main {
    public static void main(String[] args) {
        ...
        Product product1 = new Product("Груша", 45.5, 4.5);
        ...
        Product product4 = new Product("Говядина", 545.90, 10.5);
        Product product5 = new Product("Курица", 145.0, 7.7);
        Product product6 = new Product("Свинина", 350.50, 5.5);
        ...
        User user1 = new User("Алексеев Андрей", "123456");
        User user2 = new User("васильев Сергей", "654321");
